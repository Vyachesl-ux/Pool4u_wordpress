 ...
 (() => {
	...
	if (wp.blocks) {
		...
		wp.domReady( () => {
			...
			wp.blocks.registerBlockStyle("headspin/short-line", { name: "center", label: "Alignment center" });
			wp.blocks.registerBlockStyle("headspin/short-line", { name: "right", label: "Alignment right" });

			/**
			 * Unregister block types
			 */
			const coreBlocksToKeep = [
				"core/audio",
				"core/classic",
				"core/buttons",
				"core/button",
