...
function scrollToElement(element) {
  ...
  var centerElement = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
...
function loadRecaptcha() {
  ...
  var CAPTCHA_SITE_KEY = "6LcJSiUoAAAAAEgeaFT3TmET3--IIrHeNzCfFHjK";
  grecaptcha.ready(function () {
    grecaptcha.execute(CAPTCHA_SITE_KEY, {
      action: 'submit'
    }).then(function (token) {
      var captchaResponses = document.querySelectorAll("#g-recaptcha-response");
      if (captchaResponses) for (var i = 0; i < captchaResponses.length; i++) {
        captchaResponses[i].value = token;
      }
...
(function () {
  ...
  */
  var grecaptchaFields = document.querySelectorAll("input[name='g-recaptcha-response']");
  if (grecaptchaFields) {
    grecaptchaFields.forEach(function (grecaptchaField) {
      var form = getClosestByTag(grecaptchaField, "form");
      var elements = form.querySelectorAll("input, textarea, select");
      elements.forEach(function (i) {
        return i.addEventListener("focus", function (e) {
          return document.body.classList.add("show-captcha-badge");
        });
      });
    });
...
(function () {
  var play = document.querySelector('.swiper-autoplay-option');
  var protectionOptions = document.querySelectorAll('.protection-description-wrapper');
  ...
  var swiper = new Swiper(".swiper", {
    ...
    pagination: {
      ...
      renderBullet: function renderBullet(index, className) {
        var sunphadeService = ["Sunphade", "No protection", "Screens", "Blinds"];
        return "<span class=".concat(className, "><div>").concat(sunphadeService[index], "</div></span>");
      }
    },
    effect: "fade",
    on: {
      slideChange: function slideChange() {
        ...
        var slideAttribute = currentSlide.getAttribute('data-protection');
